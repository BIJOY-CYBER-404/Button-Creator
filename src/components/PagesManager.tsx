...
import { Copy, Eye, Trash2, ExternalLink, RefreshCw, FileText, Globe, Layers, ShieldCheck } from "lucide-react";
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-[#f0f4f9]">
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-[#5f6368]">
              All generated episode button pages.
            </p>
          </div>
          ...
          <div className="space-y-3">
            {filtered.map((p) => {
              ...
              return (
                <div
                  key={`page-row-${p.id}`}
                  className="bg-white hover:bg-[#fdfdff] rounded-xl p-4 border border-[#e3e7ee] hover:border-[#c2e7ff] flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-all shadow-2xs"
                >
